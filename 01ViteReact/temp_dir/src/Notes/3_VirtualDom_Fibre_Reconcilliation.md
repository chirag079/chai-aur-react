...
Since React applications are generally SPAs (Single Page Applications), React keeps updating different portions of the same UI tree instead of reloading the entire page via ejection and injection.
